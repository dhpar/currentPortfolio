...
export const Projects = () =>(
    <ul className="flex flex-col gap-4 border border-amber-200 p-4">
        {resume.projects.map(({name, link, description, tech}, i) => (
            <li key={i} className="">
                <a href={link} className="border border-amber-200 grid gap-y-8 gap-x-4 grid-cols-[repeat(auto-fit,minmax(200px,1fr2fr))] p-4 hover:bg-amber-200 hover:text-amber-900">
